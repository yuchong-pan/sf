...
(* The tactic [destruct] moves only variables from the hypothesis of the goal to the context. The tactic [induction] moves not only variables but also the induction hypothesis from the hypothesis of the goal to the context. *)
*)
(** [] *)
...
(** Translate your solution for [plus_comm] into an informal proof:
    ...
    Proof: We need to show that for every natural number n and m,
